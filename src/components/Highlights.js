const Highlights = () => {
  return (
    <div className="highlights">
      <h2>Highlights</h2>
      <div className="highlight-main" style={{ marginBottom: "20px", backgroundColor: "#2b2620", padding: "20px", color: "white", borderRadius: "8px" }}>
      ...
      <div className="sub-sections" style={{ display: "flex", gap: "20px" }}>
        <div className="sub-section" style={{ flex: 1, padding: "20px", backgroundColor: "#423d37", color: "white", borderRadius: "8px" }}>
